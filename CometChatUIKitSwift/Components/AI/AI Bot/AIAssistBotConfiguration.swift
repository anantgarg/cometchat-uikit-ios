//
//  AIAssistBotConfiguration.swift
//
//
...
public class AIAssistBotConfiguration {
    ...
    private(set) var apiConfiguration: ((_ bot: User, _ user: User?, _ group: Group?, _ configuration: (_ configuration: [String: Any]) -> Void) -> Void)?
    ...
    @discardableResult
    public func set(apiConfiguration: ((_ bot: User, _ user: User?, _ group: Group?, _ configuration: (_ configuration: [String: Any]) -> Void) -> Void)?) -> Self {
