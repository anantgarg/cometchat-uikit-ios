...
open class CometChatAIConversationStarter: UIView {
    ...
    open func buildUI() {
        ...
        NSLayoutConstraint.activate([
            tableView.topAnchor.constraint(equalTo: topAnchor, constant: CometChatSpacing.Padding.p2),
            tableView.leadingAnchor.constraint(equalTo: leadingAnchor),
            tableView.trailingAnchor.constraint(equalTo: trailingAnchor),
            tableView.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -CometChatSpacing.Padding.p),
        ])
    }
    ...
    public func showLoadingView() {
        ...
        loadingView.topAnchor.constraint(equalTo: topAnchor, constant: CometChatSpacing.Padding.p2).isActive = true
    ...
    @objc public func show(error: Bool) -> Self {
        if error {
            ...
            NSLayoutConstraint.activate([
                errorView.topAnchor.constraint(equalTo: topAnchor, constant: CometChatSpacing.Padding.p2),
