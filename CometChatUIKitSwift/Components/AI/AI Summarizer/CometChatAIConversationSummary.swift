//
//  CometChatAIConversationSummary.swift
//
//
...
open class CometChatAIConversationSummary: UIView {
    ...
    open func setupStyle() {
        ...
        roundViewCorners(corner: style.cornerRadius ?? .init(cornerRadius: CometChatSpacing.Radius.r2))
        applyCornerRadiusAndShadow(cornerRadius: style.cornerRadius?.cornerRadius ?? CometChatSpacing.Radius.r2)
        titleLabel.textColor = style.titleTextColor
        titleLabel.font = style.titleTextFont
        descriptionLabel.textColor = style.summaryTextColor
        descriptionLabel.font = style.summaryTextFont
        closeButton.setImage(style.cancelButtonImage, for: .normal)
        closeButton.tintColor = style.cancelButtonImageTintColor
