...
import Foundation
    ...
    public extension CometChatCallLogs {
        // MARK: Data
        ...
        @discardableResult
        func set(callRequestBuilder: Any?) -> Self {
        ...
        /// - Returns: CometChatCallLogs (Self)
        @discardableResult
        func set(onError: ((_ error: Any) -> Void)?) -> Self {
        ...
        /// - Returns: CometChatCallLogs (Self)
        @discardableResult
        func set(onLoad: @escaping (([Any]) -> Void)) -> Self {
            self.onLoad = onLoad
            return self
        }
        ...
        /// - Returns: CometChatCallLogs (Self)
        @discardableResult
        func set(onItemClick: ((_ callLog: Any) -> Void)?) -> Self {
        ...
        /// - Returns: CometChatCallLogs (Self)
        @discardableResult
        func set(onItemLongClick: ((_ callLog: Any, _ indexPath: IndexPath) -> Void)?) -> Self {
        ...
        /// - Returns: CometChatCallLogs (Self)
        @discardableResult
        func set(datePattern: @escaping ((_ callLog: Any) -> String)) -> Self {
        ...
        /// - Returns: CometChatCallLogs (Self)
        @discardableResult
        func set(options: ((_ callLog: Any) -> [CometChatCallOption])?) -> Self {
        ...
        /// - Returns: CometChatCallLogs (Self)
        @discardableResult
        func add(options: ((_ callLog: Any) -> [CometChatCallOption])?) -> Self {
            addOptions = options
            return self
        }
        ...
        /// - Returns: CometChatCallLogs (Self)
        @discardableResult
        func set(subtitleView: ((_ callLog: Any) -> UIView)?) -> Self {
        ...
        /// - Returns: CometChatCallLogs (Self)
        @discardableResult
        func set(trailView: ((_ callLog: Any) -> UIView)?) -> Self {
        ...
        /// - Returns: CometChatCallLogs (Self)
        @discardableResult
        func set(titleView: ((_ callLog: Any) -> UIView)?) -> Self {
        ...
        /// - Returns: CometChatCallLogs (Self)
        @discardableResult
        func set(listItemView: ((_ callLog: Any) -> UIView)?) -> Self {
        ...
        /// - Returns: CometChatCallLogs (Self)
        @discardableResult
        func set(onCallButtonClicked: ((Any) -> Void)?) -> Self {
        ...
        /// - Returns: CometChatCallLogs (Self)
        @discardableResult
        func set(leadingView: ((_ callLog: Any) -> UIView)?) -> Self {
        ...
        /// - Returns: CometChatCallLogs (Self)
        @discardableResult
        func set(goToCallLogDetail: ((_ callLog: Any, _ user: User?, _ group: Group?) -> Void)?) -> Self {
