...
public struct IncomingCallStyle {
    public var overlayBackgroundColor: UIColor = .dynamicColor(
    ...
    public var acceptButtonCornerRadius: CometChatCornerStyle?
    public var rejectButtonCornerRadius: CometChatCornerStyle?
    ...
    public var acceptButtonImage: UIImage = .init(systemName: "phone.fill")?.withRenderingMode(.alwaysTemplate) ?? UIImage()
    public var rejectButtonImage: UIImage = .init(systemName: "phone.down.fill")?.withRenderingMode(.alwaysTemplate) ?? UIImage()
