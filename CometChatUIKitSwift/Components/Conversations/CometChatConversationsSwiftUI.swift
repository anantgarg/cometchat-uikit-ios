...
public struct CometChatConversationsSwiftUI: View {
    ...
    private var privateGroupIcon: Image = .init(systemName: "shield.fill")
    private var protectedGroupIcon: Image = .init(systemName: "lock.fill")
    ...
    public init(style: ConversationsStyle = CometChatConversationsSwiftUI.style) {
        self.style = style
        avatarStyle = CometChatConversationsSwiftUI.avatarStyle
        statusIndicatorStyle = CometChatConversationsSwiftUI.statusIndicatorStyle
        receiptStyle = CometChatConversationsSwiftUI.receiptStyle
        badgeStyle = CometChatConversationsSwiftUI.badgeStyle
        dateStyle = CometChatConversationsSwiftUI.dateStyle
        typingIndicatorStyle = CometChatConversationsSwiftUI.typingIndicatorStyle
    }
    ...
    public func set(listItemView: @escaping (Conversation) -> some View) -> CometChatConversationsSwiftUI {
        var view = self
    ...
    public func set(leadingView: @escaping (Conversation) -> some View) -> CometChatConversationsSwiftUI {
        var view = self
    ...
    public func set(titleView: @escaping (Conversation) -> some View) -> CometChatConversationsSwiftUI {
        var view = self
    ...
    public func set(subtitleView: @escaping (Conversation) -> some View) -> CometChatConversationsSwiftUI {
        var view = self
    ...
    public func set(tailView: @escaping (Conversation) -> some View) -> CometChatConversationsSwiftUI {
        var view = self
    ...
    public func set(emptyStateView: @escaping () -> some View) -> CometChatConversationsSwiftUI {
        var view = self
        view.emptyStateView = {
    ...
    public func set(errorStateView: @escaping () -> some View) -> CometChatConversationsSwiftUI {
        var view = self
        view.errorStateView = {
    ...
    public func set(loadingStateView: @escaping () -> some View) -> CometChatConversationsSwiftUI {
        var view = self
...
public extension CometChatConversationsSwiftUI {
    func toUIKit() -> UIView {
