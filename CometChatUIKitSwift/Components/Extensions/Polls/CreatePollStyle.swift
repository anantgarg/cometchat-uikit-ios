...
public struct CreatePollStyle {
    ...
    public var questionInputBoxCornerRadius: CometChatCornerStyle?
    ...
    public var optionsInputBoxCornerRadius: CometChatCornerStyle?
    ...
    public var cancelButtonCornerRadius: CometChatCornerStyle?
    ...
    public var sendButtonCornerRadius: CometChatCornerStyle?
    ...
    public var deleteButtonImage: UIImage = .init(systemName: "xmark")?.withRenderingMode(.alwaysTemplate) ?? UIImage()
    public var dragButtonTintColor: UIColor = CometChatTheme.iconColorSecondary
    public var dragButtonImage: UIImage = .init(named: "drag-options-icon", in: CometChatUIKit.bundle, with: nil)?.withRenderingMode(.alwaysTemplate) ?? UIImage()
    ...
    public var errorViewCornerRadius: CometChatCornerStyle?
    ...
    public var errorImage: UIImage = .init(systemName: "exclamationmark.circle")?.withRenderingMode(.alwaysTemplate) ?? UIImage()
