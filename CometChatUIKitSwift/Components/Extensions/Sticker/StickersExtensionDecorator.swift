//
//  StickersExtensionDecorator.swift
//
//
...
class StickersExtensionDecorator: DataSourceDecorator {
    ...
    public func getStickerKeyboard(user: User?, group: Group?, controller _: UIViewController?, id: [String: Any]?) -> CometChatStickerKeyboard {
