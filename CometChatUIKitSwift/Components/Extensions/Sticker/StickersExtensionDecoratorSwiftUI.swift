...
class StickersExtensionDecoratorSwiftUI: DataSourceDecorator {
    ...
    public func getStickerKeyboard(user: User?, group: Group?, controller: UIViewController?, id: [String: Any]?) -> UIView {
    ...
    public func getStickerMessageBubblePublisher(stickerUrl: String?, message: CometChatSDK.CustomMessage?, controller: UIViewController?, style: StickerBubbleStyle?, additionalConfiguration: AdditionalConfiguration?) -> AnyPublisher<CometChatStickerBubbleSwiftUI, Never> {
        let stickerBubbleSwiftUI = CometChatStickerBubbleSwiftUI()
            .set(imageUrl: stickerUrl ?? "")
    ...
    public func getStickerKeyboardPublisher(user: User?, group: Group?, controller: UIViewController?, id: [String: Any]?) -> AnyPublisher<CometChatStickerKeyboardSwiftUI, Never> {
        let stickerKeyboardSwiftUI = CometChatStickerKeyboardSwiftUI()
