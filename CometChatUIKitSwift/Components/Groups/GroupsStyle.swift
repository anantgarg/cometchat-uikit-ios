...
public struct GroupsStyle: ListBaseStyle, ListItemStyle, SearchBarStyle {
    ...
    public var listItemSelectedImage: UIImage = .init(systemName: "checkmark.square.fill")?.withRenderingMode(.alwaysTemplate) ?? UIImage()

    // Check box image when list item is deselected
    public var listItemDeSelectedImage: UIImage = .init(systemName: "square")?.withRenderingMode(.alwaysTemplate) ?? UIImage()
    ...
    public var privateGroupIcon: UIImage = .init(systemName: "shield.fill")?.withRenderingMode(.alwaysTemplate) ?? UIImage()

    // Image for a protected group icon
    public var protectedGroupIcon: UIImage = .init(systemName: "lock.fill")?.withRenderingMode(.alwaysTemplate) ?? UIImage()
