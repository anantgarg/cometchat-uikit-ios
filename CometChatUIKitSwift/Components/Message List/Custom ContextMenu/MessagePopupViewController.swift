    ...
    func openEmojiKeyboard() {
        ...
        if (reactionView.frame.maxY - 300) > minY {
            emojiKeyboard.view.frame = CGRect(
                x: messageAlignment == .left ? Int(reactionView.frame.minX) : Int(reactionView.frame.maxX - 300),
...
class ContextMenuTableView: UITableView, UITableViewDataSource, UITableViewDelegate {
    ...
    func setUp() {
        ...
        register(ContextMenuTextCell.self, forCellReuseIdentifier: ContextMenuTextCell.identifier)
