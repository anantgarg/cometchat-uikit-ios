...
open class ReactionListConfiguration {
    ...
    private(set) var onTappedToRemoveClicked: ((_ messageReaction: CometChatSDK.Reaction, _ messageObject: BaseMessage) -> Void)?
    ...
    @discardableResult
    public func set(onTappedToRemoveClicked: ((_ messageReaction: CometChatSDK.Reaction, _ messageObject: BaseMessage) -> Void)?) -> Self {
