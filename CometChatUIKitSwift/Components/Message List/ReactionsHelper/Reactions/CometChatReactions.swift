...
public extension CometChatReactions {
    ...
    /// - Returns: The instance of `CometChatReactions` for method chaining.
    @discardableResult
    func set(reactionAlignment: MessageBubbleAlignment) -> Self {
    ...
    /// - Returns: The instance of `CometChatReactions` for method chaining.
    @discardableResult
    func set(onReactionsLongPressed: @escaping ((_ reaction: ReactionCount, _ baseMessage: BaseMessage?) -> Void)) -> Self {
    ...
    /// - Returns: The instance of `CometChatReactions` for method chaining.
    @discardableResult
    func set(onReactionsPressed: @escaping ((_ reaction: ReactionCount, _ baseMessage: BaseMessage?) -> Void)) -> Self {
    ...
    /// - Returns: The instance of `CometChatReactions` for method chaining.
    @discardableResult
    func set(configuration: ReactionsConfiguration?) -> Self {
